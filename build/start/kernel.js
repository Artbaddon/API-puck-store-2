...
Server_1.default.middleware.registerNamed({
    isGuest: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/IsGuest'))),
    isAdmin: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/IsAdmin'))),
